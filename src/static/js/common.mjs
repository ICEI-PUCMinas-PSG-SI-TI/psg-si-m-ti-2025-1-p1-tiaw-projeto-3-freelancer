                    ...
                    for (let j = 0; j < genRandomNumber(6, 3); j++) {
                        let linke =
                            exemplos.links_externos[
                                genRandomNumber(exemplos.links_externos.length)
                            ];
                        secao.contents.push({
                            blob: linke, // portfolios.secao.contents.blob - string
...
export async function createNContratos(number) {
    ...
    for (let index = 0; index < number; index++) {
        ...
        let data =
            genRandomNumber(28) + "/" + genRandomNumber(12) + "/" + genRandomNumber(2006, 1970);
...
export async function createNUsers(number) {
    ...
    for (let index = 0; index < number; index++) {
        ...
        let data_nascimento =
            genRandomNumber(28) + "/" + genRandomNumber(12) + "/" + genRandomNumber(2026, 1970);
...
export async function createNServicos(number) {
    ...
    for (let index = 0; index < number; index++) {
        let titulo =
            exemplos.categorias_servicos[genRandomNumber(exemplos.categorias_servicos.length)];
